...
class GenericProvider {
    ...
    getLatestVersion() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            try {
                result = yield (0, (_electronBuilderHttp || _load_electronBuilderHttp()).request)({ hostname: _this.baseUrl.hostname, port: _this.baseUrl.port || "443", path: `${ pathname }${ _this.baseUrl.search || "" }` });
            } catch (e) {
